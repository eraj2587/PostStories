...
namespace APIService.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            "Dear user,<br/>Please confirm your account by clicking this link: <a href=\"" + callbackUrl + "\">link</a><br/><br/>Regards<br/>Team KindActs");
            }
        ...
        public async Task<IHttpActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                "Dear "+user.UserInfo.FirstName+" "+user.UserInfo.LastName+",<br/>Please reset your password by clicking here: <a href=\"" + callbackUrl + "\">link</a><br/><br/>Regards<br/>Team KindActs");
